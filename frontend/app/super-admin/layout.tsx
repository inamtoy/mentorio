      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          ...
          <div className="hidden sm:block text-left">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">{t("superAdminBadge")}</p>
          </div>
          <ChevronDown
            className={cn(
...
export default function SuperAdminLayout({
  ...
  // default from Theme > compactSidebar (this very portal's own Settings
  // page), not a forced state.
